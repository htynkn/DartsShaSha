...
public class Scythe extends Actor {
    ...
    private int titleHeight = 48; // 声明块高度
    private int margin = 2; // 血条和人物之间的间隔
    private int pixHeight = 5; // 血条高度
    private int maxHp; // 总血量
    private int currentHp; // 当前血量l
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(currentFrame, this.getX(), this.getY(), this.titleWidth,
                this.titleHeight); // 绘制
        Pixmap pixmap = new Pixmap(64, 8, Pixmap.Format.RGBA8888); // 生成一张64*8的图片
